    ...
    public partial class WynajmijPokojDetail : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                _data.Pokoj = _dataPok;
                _data.UstalonaCenaNajmu = _dataPok.CenaWynajmuPokoju;
            }
        ...
        private void btnZapisz_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                if ((_data.Nieruchomosc == null) ||
                   (_data.Pokoj == null) ||
                   (_data.OsobaNajmujaca == null) ||
                   (_data.UstalonaCenaNajmu == 0) ||
                   (_data.WynajemOd == null) ||
                   (_data.WynajemDo == null) ||
                   (_data.Identyfikator == null))
                {
